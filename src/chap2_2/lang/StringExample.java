...
public class StringExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=================");
        System.out.println("String.charAt(index) : String에서 i번째 문자를 반환");
        System.out.println("c = " + c);

        // String.substring(beginIndex, (생략가능)endIndex) : beginIndex부터 endIndex "전"까지를 출력
        System.out.println("=================");
        System.out.println("String.substring(beginIndex, (생략가능)endIndex) : beginIndex부터 endIndex \"전\"까지를 출력");
        ...
        String food = "사과, 딸기, 포도, 배";
        String[] foodSplit = food.split(",");
        for (int i = 0; i < foodSplit.length; i++) {
            foodSplit[i] = foodSplit[i].trim();
        }
        System.out.println(Arrays.toString(foodSplit));
